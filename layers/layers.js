...
lyr_WNIOSKIWNIOSKOWANEPRZEZNACZENIE_11.set('fieldAliases', {'tresc': 'tresc', 'nr_dzialki': 'nr_dzialki', 'nr_wniosku': 'nr_wniosku', 'nr_wyszuk': 'nr_wyszuk', });
...
lyr_WNIOSKIWNIOSKOWANEPRZEZNACZENIE_11.set('fieldImages', {'tresc': 'TextEdit', 'nr_dzialki': 'TextEdit', 'nr_wniosku': 'Range', 'nr_wyszuk': '', });
...
lyr_Dzialki_9.set('fieldLabels', {'ID_DZIALKI': 'hidden field', 'NUMER_DZIA': 'no label', 'laczone': 'hidden field', });
lyr_Budynki_10.set('fieldLabels', {'ID_BUDYNKU': 'no label', 'RODZAJ': 'no label', 'KONDYGNACJ': 'no label', 'KONDYGNA_1': 'no label', });
lyr_WNIOSKIWNIOSKOWANEPRZEZNACZENIE_11.set('fieldLabels', {'tresc': 'no label', 'nr_dzialki': 'no label', 'nr_wniosku': 'no label', 'nr_wyszuk': 'no label', });
